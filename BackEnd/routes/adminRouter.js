...
const { endPoint, getAllAdmin, getAdmin, createAdmin, updateAdmin, deleteAdmin } =require('../controllers/adminController')

//notre Api
routerAdmin.post('/login',endPoint) // connexion a la bd "http://localhost:3000/admin/login"
